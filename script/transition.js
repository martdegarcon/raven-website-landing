...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Не запускать revealTransition при первой загрузке, если есть прелоадер
  const preloader = document.getElementById('preloader');
  // Запускаем revealTransition только если прелоадера нет (переход между страницами)
  if (!preloader || preloader.style.display === 'none' || preloader.offsetParent === null) {
    revealTransition();
  }
