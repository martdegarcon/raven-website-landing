...
function init() {
  ...
  // Если прелоадер существует, НЕ показываем меню - его покажет preloader.js после скрытия прелоадера
  // Если прелоадера нет, показываем меню сразу
  ...
  // Если прелоадер есть, не показываем меню - его покажет preloader.js в hidePreloader()
